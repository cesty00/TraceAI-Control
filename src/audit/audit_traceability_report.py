    ...
    for order in production_orders:
        documents.append(
            PhysicalDocumentRequirement(
                ...
                "required",
                document_number=order.production_order or MISSING,
                document_date=order.production_date or MISSING,
            )
        )
    for delivery in downstream:
        documents.append(
            PhysicalDocumentRequirement(
                ...
                "required",
                document_number=delivery.document_number or MISSING,
                client=delivery.client or MISSING,
                delivery_date=delivery.delivery_date or MISSING,
            )
        )
    for line in upstream:
        documents.append(
