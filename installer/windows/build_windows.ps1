...
$GeneratedModulePath = Join-Path $RepoRoot 'src\core\_generated_build_info.py'
$GeneratedModule = @"
# Auto-generated by installer/windows/build_windows.ps1. Do not edit manually.
BUILD_INFO = {
    "app_version": "$AppVersion",
    "build_commit": "$BuildCommit",
    "build_date": "$BuildDate",
...
"@
$GeneratedModule | Set-Content -Path $GeneratedModulePath -Encoding UTF8
Write-Host "Generated build metadata module: $GeneratedModulePath" -ForegroundColor Cyan
...
$PyInstallerArgs = @(
    ...
    '--hidden-import', 'src.core._generated_build_info',
    '--add-data', $AddDataArg,
    $EntryPoint
)
